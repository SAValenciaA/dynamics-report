...
\subsection{Selección del sistema de medición}
...
\subsection{Selección del mecanismo de accionamiento}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{cremallera.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{tornillo.png}
...
\subsection{Selección del material de las barras}
...
\subsection{Diseño asistido por computador}
