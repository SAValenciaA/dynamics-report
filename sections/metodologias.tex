...
\subsection{Ilustracion de los componentes elegidos}
\begin{figure}[H]
		\centering
		\includegraphics[height=3cm]{img/esp32.jpg}
		\caption{Ejemplo de un ESP32. \$ 25000}
		\label{fig:esp32}
\end{figure}

\begin{figure}[H]
		\centering
		\includegraphics[height=3cm]{img/BMI160.jpg}
		\caption{Ejemplo de un BMI160. \$ 10000 C/U}
		\label{fig:bmi}
\end{figure}
...
\begin{figure}[H]
		\centering
		\includegraphics[height=2cm]{img/nema17.jpg}
		\caption{Ejemplo de un motor Nema 17. \$60000 C/U}
		\label{fig:motor}
\end{figure}
